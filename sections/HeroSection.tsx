    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          ...
          <p>
          With expertise in React, Next.js, JavaScript, Node.js, Express.js, MongoDB, PostgreSQL, HTML, CSS, and SQL, I combine technical knowledge with creative problem-solving to deliver dynamic, scalable, and user-friendly web applications. I thrive in full-stack development, ensuring both the frontend and backend work harmoniously to create seamless user experiences.
          </p>
        </div>
        ...
        <a className="bg-marrsgreen hover:bg-marrslight active:bg-marrsdark dark:hover:bg-carrilight dark:active:bg-carridark dark:bg-carrigreen text-bglight dark:text-bgdark py-2 px-3 rounded lg:text-xl inline-block text-center"
         href="/my-resume.pdf"
        >
          View My Resume
        </a>

...
import Chirag from "../public/my-image.jpg";
    ...
    >
      <section id="whoami" className="section">
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              I'm a full-stack developer skilled in building scalable web applications using modern technologies like React, Node.js, and MongoDB or PostgreSQL. I enjoy solving complex problems and delivering clean, user-focused solutions from frontend to backend.
            </p>
            ...
            <div className="col-span-5 mt-12">
             ...
             <p>Driven by a love for technology and innovation, I've honed my skills in software development, delivering high-quality solutions that meet real-world needs. 
             Here's my expertise.</p>
             <div className="flex flex-wrap gap-8 justify-evenly mt-6">
             {skillGroups.map((group, i) => (
             <div key={i} className="flex flex-col  lg:w-[22%] space-y-6 mb-2">
              <h4 className="text-xl font-semibold text-marrsgreen dark:text-carrigreen">
              {group.title}
              </h4>
...
const educationInfo = [
  {
    ...
    subTitle: "Dr. A.P.J Abdul Kalam Technical University, Lucknow | 2022 - present",
    list: [
      "Studied computer science, software development",
      "Web development ",
  ...
  },
  {
    id: 2,
    title: "Intermediate",
    subTitle: "Kendriya Vidyalaya Air Force Station, Bareilly | 2021 - 2022",
    list: [
      "Completed with Computer Science specialization",
      "Studied fundamentals of programming",
      "Developed basic projects using Python"
    ],
  },
  {
    id: 3,
    title: "High School",
    subTitle: "Kendriya Vidyalaya Air Force Station, Bareilly | 2019 - 2020",
    list: ["Completed with an overall score of 84%"],
  },
];
...
const skillGroups = [
  ...
  {
    title: "Frameworks",
    skills: ["React", "Next.js", "Tailwind CSS","BootStrap", "Node.js", "Express.js"],
  },
  {
    title: "Databases",
  ...
  {
    title: "Tools",
    skills: ["Git", "Vercel", "Netlify","Github Actions","VS Code","Docker"],
  },
];
